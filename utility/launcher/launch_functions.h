...
void launch_i(int32_t threads, Ts... args) {
	static auto structure = get<parameters::internal::cell_structure>();
	//	static auto ordering = get<parameters::internal::cell_ordering>();
	static auto width = get<parameters::internal::hash_size>();
...
template <launch_config cfg, template <launch_config, neighbor_list, typename...> class T,
	typename... Vs, typename... Ts>
	void launch_i(int32_t threads, Ts... args) {
	static auto neighborhood = get<parameters::internal::neighborhood_kind>();
