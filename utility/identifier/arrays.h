...
struct refinementRatio{
	using type = float;
	using unit_type = float;
	static constexpr const array_enum identifier = array_enum::adaptive_refinementRatio;
	static constexpr const auto variableName = "refinementRatio";
	static constexpr const auto qualifiedName = "adaptive.refinementRatio";
	static constexpr const auto ambiguous = false;
	static float* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains the refinement ratio of every particle according to a decision function.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.refinementRatio;}
};
...
struct mergeIndicator{
	using type = int32_t;
	using unit_type = int32_t;
	static constexpr const array_enum identifier = array_enum::adaptive_mergeIndicator;
	static constexpr const auto variableName = "mergeIndicator";
	static constexpr const auto qualifiedName = "adaptive.mergeIndicator";
	static constexpr const auto ambiguous = false;
	static int32_t* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains an indicator that is incremented over time or reset depending on the classification of a particle as L over time.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.mergeIndicator;}
};
...
struct vorticity{
	using type = float4;
	using unit_type = value_unit<float4, SI::velocity>;
	static constexpr const array_enum identifier = array_enum::advectionArrays_vorticity;
	static constexpr const auto variableName = "vorticity";
	static constexpr const auto qualifiedName = "advectionArrays.vorticity";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
...
struct optimization_lifetime{
	using type = int;
	using unit_type = value_unit<int, void_unit_ty>;
	static constexpr const array_enum identifier = array_enum::basicArrays_optimization_lifetime;
	static constexpr const auto variableName = "optimization_lifetime";
	static constexpr const auto qualifiedName = "basicArrays.optimization_lifetime";
	static constexpr const auto ambiguous = false;
	static int* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the number of iterations neede for post splitting optimization";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.optimization_lifetime;}
};
struct optimization_lifetime_merge{
	using type = int;
	using unit_type = value_unit<int, void_unit_ty>;
	static constexpr const array_enum identifier = array_enum::basicArrays_optimization_lifetime_merge;
	static constexpr const auto variableName = "optimization_lifetime_merge";
	static constexpr const auto qualifiedName = "basicArrays.optimization_lifetime_merge";
	static constexpr const auto ambiguous = false;
	static int* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the number of iterations neede for post merging optimization";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.optimization_lifetime_merge;}
};
struct resortArray4{
	using type = float4;
	using unit_type = float4;
...
struct optimization_group{
	using type = int;
	using unit_type = value_unit<int, void_unit_ty>;
	static constexpr const array_enum identifier = array_enum::basicArrays_optimization_group;
	static constexpr const auto variableName = "optimization_group";
	static constexpr const auto qualifiedName = "basicArrays.optimization_group";
	static constexpr const auto ambiguous = false;
	static int* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the id of the common fluid parent for splitted boundary particles";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.optimization_group;}
};
struct pressure{
	using type = float;
...
struct old_density{
	using type = float;
	using unit_type = value_unit<float, void_unit_ty>;
	static constexpr const array_enum identifier = array_enum::basicArrays_old_density;
	static constexpr const auto variableName = "old_density";
	static constexpr const auto qualifiedName = "basicArrays.old_density";
	static constexpr const auto ambiguous = false;
	static float* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the density of a particle, calculated in the density module. This value is not filtered by any shepard or related filters.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.old_density;}
};
struct density_b{
	using type = float;
	using unit_type = value_unit<float, void_unit_ty>;
	static constexpr const array_enum identifier = array_enum::basicArrays_density_b;
	static constexpr const auto variableName = "density_b";
	static constexpr const auto qualifiedName = "basicArrays.density_b";
	static constexpr const auto ambiguous = false;
	static float* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the density of a particle for fluid-boundary interaction, calculated in the density module. ";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.density_b;}
};
struct density_f{
	using type = float;
	using unit_type = value_unit<float, void_unit_ty>;
	static constexpr const array_enum identifier = array_enum::basicArrays_density_f;
	static constexpr const auto variableName = "density_f";
	static constexpr const auto qualifiedName = "basicArrays.density_f";
	static constexpr const auto ambiguous = false;
	static float* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the density of a particle for fluid-fluid interaction, calculated in the density module. ";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.density_f;}
};
...
struct sdf_gridsize{
	using type = float;
	using unit_type = float;
	static constexpr const array_enum identifier = array_enum::basicArrays_sdf_gridsize;
	static constexpr const auto variableName = "sdf_gridsize";
	static constexpr const auto qualifiedName = "basicArrays.sdf_gridsize";
	static constexpr const auto ambiguous = false;
	static float* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Used to store grid size of sdf";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.sdf_gridsize;}
};
struct sdf_minpoint2{
	using type = float4;
	using unit_type = float4;
	static constexpr const array_enum identifier = array_enum::basicArrays_sdf_minpoint2;
	static constexpr const auto variableName = "sdf_minpoint2";
	static constexpr const auto qualifiedName = "basicArrays.sdf_minpoint2";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Used to store grid min point of sdf";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.sdf_minpoint2;}
};
struct sdf_minpoint1{
	using type = float3;
	using unit_type = float3;
	static constexpr const array_enum identifier = array_enum::basicArrays_sdf_minpoint1;
	static constexpr const auto variableName = "sdf_minpoint1";
	static constexpr const auto qualifiedName = "basicArrays.sdf_minpoint1";
	static constexpr const auto ambiguous = false;
	static float3* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Used to store grid min point of sdf";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.sdf_minpoint1;}
};
struct position{
	using type = float4;
	using unit_type = value_unit<float4, SI::m>;
...
struct acceleration_inter{
	using type = float4;
	using unit_type = value_unit<float4, SI::acceleration>;
	static constexpr const array_enum identifier = array_enum::basicArrays_acceleration_inter;
	static constexpr const auto variableName = "acceleration_inter";
	static constexpr const auto qualifiedName = "basicArrays.acceleration_inter";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the intermediate acceleration of every particle. This value needs to be set to zero on every time step as the old value is resorted as the initial value for certain functions but this is not desirable in calculalting the new accelerations later in the timestep.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.acceleration_inter;}
};
struct velocity{
	using type = float4;
	using unit_type = value_unit<float4, SI::velocity>;
...
struct rigidbody_sdf{
	using type = float;
	using unit_type = float;
	static constexpr const array_enum identifier = array_enum::basicArrays_rigidbody_sdf;
	static constexpr const auto variableName = "rigidbody_sdf";
	static constexpr const auto qualifiedName = "basicArrays.rigidbody_sdf";
	static constexpr const auto ambiguous = false;
	static float* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores sdf for all rigid bodies";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.rigidbody_sdf;}
};
struct rigidbody_sdf2{
	using type = float;
	using unit_type = float;
	static constexpr const array_enum identifier = array_enum::basicArrays_rigidbody_sdf2;
	static constexpr const auto variableName = "rigidbody_sdf2";
	static constexpr const auto qualifiedName = "basicArrays.rigidbody_sdf2";
	static constexpr const auto ambiguous = false;
	static float* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores sdf for all rigid bodies";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.rigidbody_sdf2;}
};
...
struct tobeoptimized{
	using type = int;
	using unit_type = int;
	static constexpr const array_enum identifier = array_enum::basicArrays_tobeoptimized;
	static constexpr const auto variableName = "tobeoptimized";
	static constexpr const auto qualifiedName = "basicArrays.tobeoptimized";
	static constexpr const auto ambiguous = false;
	static int* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Flag to indicate whether this paritlce needs to be optimized";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.tobeoptimized;}
};
struct uid{
	using type = int;
	using unit_type = int;
	static constexpr const array_enum identifier = array_enum::basicArrays_uid;
	static constexpr const auto variableName = "uid";
	static constexpr const auto qualifiedName = "basicArrays.uid";
	static constexpr const auto ambiguous = false;
	static int* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Stores the index of every particle.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.uid;}
};
struct renderArray{
	using type = float4;
	using unit_type = float4;
...
struct volumeBoundaryGVDBVolumes{
	using type = gvdb::VDBInfo*;
	using unit_type = gvdb::VDBInfo*;
	static constexpr const array_enum identifier = array_enum::boundaryArrays_volumeBoundaryGVDBVolumes;
	static constexpr const auto variableName = "volumeBoundaryGVDBVolumes";
	static constexpr const auto qualifiedName = "boundaryArrays.volumeBoundaryGVDBVolumes";
	static constexpr const auto ambiguous = false;
	static gvdb::VDBInfo** ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains references to boundary volumes created from vdb volumes for more complex boundary objects than planes.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.volumeBoundaryGVDBVolumes;}
};
struct gvdbOffsets{
	using type = float4;
	using unit_type = float4;
	static constexpr const array_enum identifier = array_enum::boundaryArrays_gvdbOffsets;
	static constexpr const auto variableName = "gvdbOffsets";
	static constexpr const auto qualifiedName = "boundaryArrays.gvdbOffsets";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "TODO";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.gvdbOffsets;}
};
struct gvdbVoxelSizes{
	using type = float4;
	using unit_type = float4;
	static constexpr const array_enum identifier = array_enum::boundaryArrays_gvdbVoxelSizes;
	static constexpr const auto variableName = "gvdbVoxelSizes";
	static constexpr const auto qualifiedName = "boundaryArrays.gvdbVoxelSizes";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "TODO";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.gvdbVoxelSizes;}
};
...
struct anisotropicSupport{
	using type = float4;
	using unit_type = float4;
	static constexpr const array_enum identifier = array_enum::renderArrays_anisotropicSupport;
	static constexpr const auto variableName = "anisotropicSupport";
	static constexpr const auto qualifiedName = "renderArrays.anisotropicSupport";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
	static constexpr const auto description = ".";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.anisotropicSupport;}
};
struct auxLength{
	using type = uint32_t;
	using unit_type = uint32_t;
	static constexpr const array_enum identifier = array_enum::renderArrays_auxLength;
	static constexpr const auto variableName = "auxLength";
	static constexpr const auto qualifiedName = "renderArrays.auxLength";
	static constexpr const auto ambiguous = false;
	static uint32_t* ptr;
	static size_t alloc_size;
	static constexpr const auto description = ".";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.auxLength;}
};
...
struct mlmScaling{
	...
	static int32_t* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Similar to cellSpan, however: hashMap is not used by MLM resorting at all.";
...
struct resortIndex{
	...
	static int32_t* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Used to store keys for resorting algorithms, e.g. a Z-Order Index in resort/resort. Required by all resorting methods in some way but used differently by them.";
...
struct refinementList{
	using type = int32_t;
	using unit_type = int32_t;
	static constexpr const array_enum identifier = array_enum::structureArrays_refinementList;
	static constexpr const auto variableName = "refinementList";
	static constexpr const auto qualifiedName = "structureArrays.refinementList";
	static constexpr const auto ambiguous = false;
	static int32_t* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains the real particles for which refinement is needed.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.refinementList;}
};
...
struct refinementListLength{
	using type = int32_t;
	using unit_type = int32_t;
	static constexpr const array_enum identifier = array_enum::structureArrays_refinementListLength;
	static constexpr const auto variableName = "refinementListLength";
	static constexpr const auto qualifiedName = "structureArrays.refinementListLength";
	static constexpr const auto ambiguous = false;
	static int32_t* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains the number of particles to be refined";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.refinementListLength;}
};
struct particleparticleIndex{
	...
	static int32_t* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Used for creating indices from 0:n for resorting with key-value resorting algorithms.";
...
struct volumeOutletVoxelSizes{
	using type = float4;
	using unit_type = float4;
	static constexpr const array_enum identifier = array_enum::volumeInletArrays_volumeOutletVoxelSizes;
	static constexpr const auto variableName = "volumeOutletVoxelSizes";
	static constexpr const auto qualifiedName = "volumeInletArrays.volumeOutletVoxelSizes";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains references to boundary volumes created from vdb volumes for more complex boundary objects than planes.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.volumeOutletVoxelSizes;}
};
struct volumeOutletOffsets{
	using type = float4;
	using unit_type = float4;
	static constexpr const array_enum identifier = array_enum::volumeInletArrays_volumeOutletOffsets;
	static constexpr const auto variableName = "volumeOutletOffsets";
	static constexpr const auto qualifiedName = "volumeInletArrays.volumeOutletOffsets";
	static constexpr const auto ambiguous = false;
	static float4* ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains references to boundary volumes created from vdb volumes for more complex boundary objects than planes.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.volumeOutletOffsets;}
};
...
struct outletGVDBVolumes{
	using type = gvdb::VDBInfo*;
	using unit_type = gvdb::VDBInfo*;
	static constexpr const array_enum identifier = array_enum::volumeInletArrays_outletGVDBVolumes;
	static constexpr const auto variableName = "outletGVDBVolumes";
	static constexpr const auto qualifiedName = "volumeInletArrays.outletGVDBVolumes";
	static constexpr const auto ambiguous = false;
	static gvdb::VDBInfo** ptr;
	static size_t alloc_size;
	static constexpr const auto description = "Contains references to boundary volumes created from vdb volumes for more complex boundary objects than planes.";
	...
	type& operator[](size_t idx);
	static bool valid();
	template<class T> static inline auto& get_member(T& var) { return var.outletGVDBVolumes;}
};
struct inletCounter{
	using type = int32_t;
	using unit_type = int32_t;
...
extern std::tuple<arrays::adaptive::mergeable, arrays::adaptive::mergeCounter, arrays::adaptive::ptclCounter, arrays::adaptive::classification, arrays::adaptive::refinementRatio, arrays::adaptive::splitIndicator, arrays::adaptive::mergeIndicator, arrays::adaptive::adaptivityCounter, arrays::adaptive::splitIndicatorCompacted, arrays::adaptive::parentIndex, arrays::adaptive::parentVolume, arrays::adaptive::parentPosition, arrays::advectionArrays::maxVelocity, arrays::advectionArrays::cflValue, arrays::advectionArrays::particleNormal, arrays::advectionArrays::angularVelocity, arrays::advectionArrays::vorticity, arrays::rigidBodyArrays::rigidDensities, arrays::rigidBodyArrays::rigidVolumes, arrays::rigidBodyArrays::rigidLinearVelocities, arrays::rigidBodyArrays::rigidAVelocities, arrays::rigidBodyArrays::rigidOrigins, arrays::rigidBodyArrays::rigidQuaternions, arrays::boundaryArrays::volumeBoundaryVolumes, arrays::boundaryArrays::volumeBoundaryGVDBVolumes, arrays::boundaryArrays::gvdbOffsets, arrays::boundaryArrays::gvdbVoxelSizes, arrays::boundaryArrays::volumeBoundaryDimensions, arrays::boundaryArrays::volumeBoundaryMin, arrays::boundaryArrays::volumeBoundaryMax, arrays::boundaryArrays::volumeBoundaryDensity, arrays::boundaryArrays::volumeBoundaryVolume, arrays::boundaryArrays::volumeBoundaryVelocity, arrays::boundaryArrays::volumeBoundaryAngularVelocity, arrays::boundaryArrays::volumeBoundaryKind, arrays::boundaryArrays::volumeBoundaryPosition, arrays::boundaryArrays::volumeBoundaryQuaternion, arrays::boundaryArrays::volumeBoundaryTransformMatrix, arrays::boundaryArrays::volumeBoundaryTransformMatrixInverse, arrays::boundaryArrays::volumeBoundaryInertiaMatrix, arrays::boundaryArrays::volumeBoundaryInertiaMatrixInverse, arrays::boundaryArrays::volumeBoundaryAcceleration, arrays::boundaryArrays::volumeBoundaryAngularAcceleration, arrays::surfaceArrays::decisionBuffer, arrays::surfaceArrays::surface_idxBuffer, arrays::surfaceArrays::markerBuffer, arrays::surfaceArrays::distanceBuffer, arrays::surfaceArrays::changeBuffer, arrays::basicArrays::matrixTest, arrays::basicArrays::sdf_gridsize, arrays::basicArrays::sdf_minpoint2, arrays::basicArrays::sdf_minpoint1, arrays::basicArrays::position, arrays::basicArrays::acceleration, arrays::basicArrays::acceleration_inter, arrays::basicArrays::velocity, arrays::basicArrays::rigidbody_sdf2, arrays::basicArrays::particle_type, arrays::basicArrays::tobeoptimized, arrays::basicArrays::uid, arrays::basicArrays::renderArray, arrays::basicArrays::debugArray, arrays::basicArrays::volume, arrays::basicArrays::lifetime, arrays::basicArrays::optimization_lifetime, arrays::basicArrays::optimization_lifetime_merge, arrays::basicArrays::optimization_group, arrays::basicArrays::pressure, arrays::basicArrays::density, arrays::basicArrays::old_density, arrays::basicArrays::density_b, arrays::basicArrays::density_f, arrays::basicArrays::particleIndex, arrays::basicArrays::particleIndexCompact, arrays::basicArrays::resortArray4, arrays::basicArrays::resortArray, arrays::dfsphArrays::dfsphSource, arrays::dfsphArrays::dfsphAlpha, arrays::dfsphArrays::dfsphDpDt, arrays::dfsphArrays::dfsphRhoStar, arrays::iisphArrays::iisphSum, arrays::iisphArrays::iisphDii, arrays::iisphArrays::iisphAiiOld, arrays::iisphArrays::omega, arrays::iisphArrays::alpha, arrays::iisphArrays::gamma, arrays::iisphArrays::sigma, arrays::iisphArrays::iisphDensityAdvection, arrays::iisphArrays::iisphDensityIteration, arrays::iisphArrays::kernelBuffer, arrays::iisphArrays::velocityAdvection, arrays::iisph17::sourceTerm, arrays::iisph17::boundaryPressure, arrays::iisph17::omega, arrays::iisph17::apparentVolume, arrays::iisph17::Aii, arrays::iisph17::predictedAcceleration, arrays::iisph17::volumeError, arrays::iisph17_band_rb::_sourceTerm, arrays::iisph17_band_rb::_omega, arrays::iisph17_band_rb::_apparentVolume, arrays::iisph17_band_rb::_Aii, arrays::iisph17_band_rb::_predictedAcceleration, arrays::iisph17_band_rb::_volumeError, arrays::structureArrays::compactCellList, arrays::structureArrays::neighborMask, arrays::structureArrays::compactCellScale, arrays::structureArrays::spanNeighborList, arrays::structureArrays::neighborList, arrays::structureArrays::refinementList, arrays::structureArrays::neighborListLength, arrays::structureArrays::refinementListLength, arrays::renderArrays::auxLength, arrays::renderArrays::anisotropicSupport, arrays::renderArrays::anisotropicMatrices, arrays::renderArrays::centerPosition, arrays::renderArrays::auxTest, arrays::renderArrays::auxIsoDensity, arrays::renderArrays::auxDistance, arrays::renderArrays::auxHashMap, arrays::renderArrays::auxCellSpan, arrays::renderArrays::auxCellInformation, arrays::renderArrays::auxCellSurface, arrays::structureArrays::classification, arrays::structureArrays::resortIndex, arrays::structureArrays::ZOrder_64, arrays::structureArrays::ZOrder_32, arrays::structureArrays::cellSpanSwap, arrays::structureArrays::cellSpan, arrays::structureArrays::compactCellSpanSwap, arrays::structureArrays::compactCellSpan, arrays::structureArrays::MLMResolution, arrays::structureArrays::cellparticleIndex, arrays::structureArrays::compactparticleIndex, arrays::structureArrays::hashMap, arrays::structureArrays::compactHashMap, arrays::structureArrays::mlmScaling, arrays::structureArrays::particleparticleIndex, arrays::structureArrays::cellBegin, arrays::structureArrays::cellEnd, arrays::supportArrays::support, arrays::supportArrays::supportEstimate, arrays::supportArrays::neighborCount, arrays::supportArrays::supportMarker, arrays::supportArrays::supportMarkerCompacted, arrays::supportArrays::closestNeighbor, arrays::supportArrays::closestNeighbor_f, arrays::supportArrays::neighborOverhead, arrays::supportArrays::neighborOverheadCount, arrays::supportArrays::neighborListSwap> allocations_list;
extern std::tuple<arrays::adaptive::mergeable, arrays::adaptive::mergeCounter, arrays::adaptive::ptclCounter, arrays::adaptive::classification, arrays::adaptive::refinementRatio, arrays::adaptive::splitIndicator, arrays::adaptive::mergeIndicator, arrays::adaptive::adaptivityCounter, arrays::adaptive::splitIndicatorCompacted, arrays::adaptive::parentIndex, arrays::adaptive::parentVolume, arrays::adaptive::parentPosition, arrays::advectionArrays::maxVelocity, arrays::advectionArrays::cflValue, arrays::advectionArrays::particleNormal, arrays::advectionArrays::angularVelocity, arrays::advectionArrays::vorticity, arrays::rigidBodyArrays::rigidDensities, arrays::rigidBodyArrays::rigidVolumes, arrays::rigidBodyArrays::rigidLinearVelocities, arrays::rigidBodyArrays::rigidAVelocities, arrays::rigidBodyArrays::rigidOrigins, arrays::rigidBodyArrays::rigidQuaternions, arrays::boundaryArrays::splineLUT, arrays::boundaryArrays::offsetLUT, arrays::boundaryArrays::spikyLUT, arrays::boundaryArrays::adhesionLUT, arrays::boundaryArrays::volumeLUT, arrays::boundaryArrays::spline2LUT, arrays::boundaryArrays::splineGradientLUT, arrays::boundaryArrays::spikyGradientLUT, arrays::boundaryArrays::cohesionLUT, arrays::boundaryArrays::boundaryPlanes, arrays::boundaryArrays::boundaryPlaneVelocity, arrays::boundaryArrays::volumeBoundaryVolumes, arrays::boundaryArrays::volumeBoundaryGVDBVolumes, arrays::boundaryArrays::gvdbOffsets, arrays::boundaryArrays::gvdbVoxelSizes, arrays::boundaryArrays::volumeBoundaryDimensions, arrays::boundaryArrays::volumeBoundaryMin, arrays::boundaryArrays::volumeBoundaryMax, arrays::boundaryArrays::volumeBoundaryDensity, arrays::boundaryArrays::volumeBoundaryVolume, arrays::boundaryArrays::volumeBoundaryVelocity, arrays::boundaryArrays::volumeBoundaryAngularVelocity, arrays::boundaryArrays::volumeBoundaryKind, arrays::boundaryArrays::volumeBoundaryPosition, arrays::boundaryArrays::volumeBoundaryQuaternion, arrays::boundaryArrays::volumeBoundaryTransformMatrix, arrays::boundaryArrays::volumeBoundaryTransformMatrixInverse, arrays::boundaryArrays::volumeBoundaryInertiaMatrix, arrays::boundaryArrays::volumeBoundaryInertiaMatrixInverse, arrays::boundaryArrays::volumeBoundaryAcceleration, arrays::boundaryArrays::volumeBoundaryAngularAcceleration, arrays::surfaceArrays::decisionBuffer, arrays::surfaceArrays::surface_idxBuffer, arrays::surfaceArrays::markerBuffer, arrays::surfaceArrays::distanceBuffer, arrays::surfaceArrays::changeBuffer, arrays::basicArrays::matrixTest, arrays::basicArrays::sdf_gridsize, arrays::basicArrays::sdf_minpoint2, arrays::basicArrays::sdf_minpoint1, arrays::basicArrays::position, arrays::basicArrays::acceleration, arrays::basicArrays::acceleration_inter, arrays::basicArrays::velocity, arrays::basicArrays::rigidbody_sdf, arrays::basicArrays::rigidbody_sdf2, arrays::basicArrays::particle_type, arrays::basicArrays::tobeoptimized, arrays::basicArrays::uid, arrays::basicArrays::renderArray, arrays::basicArrays::debugArray, arrays::basicArrays::volume, arrays::basicArrays::lifetime, arrays::basicArrays::optimization_lifetime, arrays::basicArrays::optimization_lifetime_merge, arrays::basicArrays::optimization_group, arrays::basicArrays::pressure, arrays::basicArrays::density, arrays::basicArrays::old_density, arrays::basicArrays::density_b, arrays::basicArrays::density_f, arrays::basicArrays::particleIndex, arrays::basicArrays::particleIndexCompact, arrays::basicArrays::resortArray4, arrays::basicArrays::resortArray, arrays::dfsphArrays::dfsphSource, arrays::dfsphArrays::dfsphAlpha, arrays::dfsphArrays::dfsphDpDt, arrays::dfsphArrays::dfsphRhoStar, arrays::iisphArrays::iisphSum, arrays::iisphArrays::iisphDii, arrays::iisphArrays::iisphAiiOld, arrays::iisphArrays::omega, arrays::iisphArrays::alpha, arrays::iisphArrays::gamma, arrays::iisphArrays::sigma, arrays::iisphArrays::iisphDensityAdvection, arrays::iisphArrays::iisphDensityIteration, arrays::iisphArrays::kernelBuffer, arrays::iisphArrays::velocityAdvection, arrays::iisph17::sourceTerm, arrays::iisph17::boundaryPressure, arrays::iisph17::omega, arrays::iisph17::apparentVolume, arrays::iisph17::Aii, arrays::iisph17::predictedAcceleration, arrays::iisph17::volumeError, arrays::iisph17_band_rb::_sourceTerm, arrays::iisph17_band_rb::_omega, arrays::iisph17_band_rb::_apparentVolume, arrays::iisph17_band_rb::_Aii, arrays::iisph17_band_rb::_predictedAcceleration, arrays::iisph17_band_rb::_volumeError, arrays::volumeInletArrays::inletPositions, arrays::volumeInletArrays::inletCounter, arrays::volumeInletArrays::outletGVDBVolumes, arrays::volumeInletArrays::volumeOutletOffsets, arrays::volumeInletArrays::volumeOutletVoxelSizes, arrays::volumeInletArrays::volumeOutletDimensions, arrays::volumeInletArrays::volumeOutletMin, arrays::volumeInletArrays::volumeOutletMax, arrays::volumeInletArrays::volumeOutletRate, arrays::volumeInletArrays::volumeOutletRateAccumulator, arrays::structureArrays::compactCellList, arrays::structureArrays::neighborMask, arrays::structureArrays::compactCellScale, arrays::structureArrays::spanNeighborList, arrays::structureArrays::neighborList, arrays::structureArrays::refinementList, arrays::structureArrays::neighborListLength, arrays::structureArrays::refinementListLength, arrays::renderArrays::auxLength, arrays::renderArrays::anisotropicSupport, arrays::renderArrays::anisotropicMatrices, arrays::renderArrays::centerPosition, arrays::renderArrays::auxTest, arrays::renderArrays::auxIsoDensity, arrays::renderArrays::auxDistance, arrays::renderArrays::auxHashMap, arrays::renderArrays::auxCellSpan, arrays::renderArrays::auxCellInformation, arrays::renderArrays::auxCellSurface, arrays::structureArrays::classification, arrays::structureArrays::resortIndex, arrays::structureArrays::ZOrder_64, arrays::structureArrays::ZOrder_32, arrays::structureArrays::cellSpanSwap, arrays::structureArrays::cellSpan, arrays::structureArrays::compactCellSpanSwap, arrays::structureArrays::compactCellSpan, arrays::structureArrays::MLMResolution, arrays::structureArrays::cellparticleIndex, arrays::structureArrays::compactparticleIndex, arrays::structureArrays::hashMap, arrays::structureArrays::compactHashMap, arrays::structureArrays::mlmScaling, arrays::structureArrays::particleparticleIndex, arrays::structureArrays::cellBegin, arrays::structureArrays::cellEnd, arrays::supportArrays::support, arrays::supportArrays::supportEstimate, arrays::supportArrays::neighborCount, arrays::supportArrays::supportMarker, arrays::supportArrays::supportMarkerCompacted, arrays::supportArrays::closestNeighbor, arrays::supportArrays::closestNeighbor_f, arrays::supportArrays::neighborOverhead, arrays::supportArrays::neighborOverheadCount, arrays::supportArrays::neighborListSwap> arrays_list;
extern std::tuple<arrays::boundaryArrays::volumeBoundaryVolumes, arrays::boundaryArrays::volumeBoundaryGVDBVolumes, arrays::boundaryArrays::gvdbOffsets, arrays::boundaryArrays::gvdbVoxelSizes, arrays::boundaryArrays::volumeBoundaryDimensions, arrays::boundaryArrays::volumeBoundaryMin, arrays::boundaryArrays::volumeBoundaryMax, arrays::boundaryArrays::volumeBoundaryDensity, arrays::boundaryArrays::volumeBoundaryVolume, arrays::boundaryArrays::volumeBoundaryVelocity, arrays::boundaryArrays::volumeBoundaryAngularVelocity, arrays::boundaryArrays::volumeBoundaryKind, arrays::boundaryArrays::volumeBoundaryPosition, arrays::boundaryArrays::volumeBoundaryQuaternion, arrays::boundaryArrays::volumeBoundaryTransformMatrix, arrays::boundaryArrays::volumeBoundaryTransformMatrixInverse, arrays::boundaryArrays::volumeBoundaryInertiaMatrix, arrays::boundaryArrays::volumeBoundaryInertiaMatrixInverse, arrays::boundaryArrays::volumeBoundaryAcceleration, arrays::boundaryArrays::volumeBoundaryAngularAcceleration, arrays::basicArrays::matrixTest, arrays::basicArrays::sdf_gridsize, arrays::basicArrays::sdf_minpoint2, arrays::basicArrays::sdf_minpoint1> individual_list;
extern std::tuple<arrays::adaptive::splitIndicator, arrays::adaptive::mergeIndicator, arrays::adaptive::parentIndex, arrays::adaptive::parentVolume, arrays::adaptive::parentPosition, arrays::advectionArrays::angularVelocity, arrays::advectionArrays::vorticity, arrays::surfaceArrays::distanceBuffer, arrays::basicArrays::position, arrays::basicArrays::acceleration, arrays::basicArrays::acceleration_inter, arrays::basicArrays::velocity, arrays::basicArrays::rigidbody_sdf2, arrays::basicArrays::particle_type, arrays::basicArrays::tobeoptimized, arrays::basicArrays::uid, arrays::basicArrays::renderArray, arrays::basicArrays::debugArray, arrays::basicArrays::volume, arrays::basicArrays::lifetime, arrays::basicArrays::optimization_lifetime, arrays::basicArrays::optimization_lifetime_merge, arrays::basicArrays::optimization_group, arrays::basicArrays::pressure, arrays::basicArrays::density, arrays::basicArrays::old_density, arrays::basicArrays::density_b, arrays::basicArrays::density_f, arrays::structureArrays::neighborListLength, arrays::structureArrays::refinementListLength> sorting_list;
extern std::tuple<arrays::adaptive::mergeable, arrays::adaptive::mergeCounter, arrays::adaptive::ptclCounter, arrays::adaptive::classification, arrays::adaptive::refinementRatio, arrays::adaptive::splitIndicator, arrays::adaptive::mergeIndicator, arrays::adaptive::splitIndicatorCompacted, arrays::adaptive::parentIndex, arrays::adaptive::parentVolume, arrays::adaptive::parentPosition, arrays::advectionArrays::maxVelocity, arrays::advectionArrays::cflValue, arrays::advectionArrays::particleNormal, arrays::advectionArrays::angularVelocity, arrays::advectionArrays::vorticity, arrays::surfaceArrays::decisionBuffer, arrays::surfaceArrays::surface_idxBuffer, arrays::surfaceArrays::markerBuffer, arrays::surfaceArrays::distanceBuffer, arrays::surfaceArrays::changeBuffer, arrays::basicArrays::position, arrays::basicArrays::acceleration, arrays::basicArrays::acceleration_inter, arrays::basicArrays::velocity, arrays::basicArrays::rigidbody_sdf2, arrays::basicArrays::particle_type, arrays::basicArrays::tobeoptimized, arrays::basicArrays::uid, arrays::basicArrays::renderArray, arrays::basicArrays::debugArray, arrays::basicArrays::volume, arrays::basicArrays::lifetime, arrays::basicArrays::optimization_lifetime, arrays::basicArrays::optimization_lifetime_merge, arrays::basicArrays::optimization_group, arrays::basicArrays::pressure, arrays::basicArrays::density, arrays::basicArrays::old_density, arrays::basicArrays::density_b, arrays::basicArrays::density_f, arrays::basicArrays::particleIndex, arrays::basicArrays::particleIndexCompact, arrays::basicArrays::resortArray4, arrays::basicArrays::resortArray, arrays::dfsphArrays::dfsphSource, arrays::dfsphArrays::dfsphAlpha, arrays::dfsphArrays::dfsphDpDt, arrays::dfsphArrays::dfsphRhoStar, arrays::iisphArrays::iisphSum, arrays::iisphArrays::iisphDii, arrays::iisphArrays::iisphAiiOld, arrays::iisphArrays::omega, arrays::iisphArrays::alpha, arrays::iisphArrays::gamma, arrays::iisphArrays::sigma, arrays::iisphArrays::iisphDensityAdvection, arrays::iisphArrays::iisphDensityIteration, arrays::iisphArrays::kernelBuffer, arrays::iisphArrays::velocityAdvection, arrays::iisph17::sourceTerm, arrays::iisph17::boundaryPressure, arrays::iisph17::omega, arrays::iisph17::apparentVolume, arrays::iisph17::Aii, arrays::iisph17::predictedAcceleration, arrays::iisph17::volumeError, arrays::iisph17_band_rb::_sourceTerm, arrays::iisph17_band_rb::_omega, arrays::iisph17_band_rb::_apparentVolume, arrays::iisph17_band_rb::_Aii, arrays::iisph17_band_rb::_predictedAcceleration, arrays::iisph17_band_rb::_volumeError, arrays::structureArrays::compactCellList, arrays::structureArrays::neighborMask, arrays::structureArrays::compactCellScale, arrays::structureArrays::spanNeighborList, arrays::structureArrays::neighborList, arrays::structureArrays::refinementList, arrays::structureArrays::neighborListLength, arrays::structureArrays::refinementListLength, arrays::renderArrays::auxLength, arrays::renderArrays::anisotropicSupport, arrays::renderArrays::anisotropicMatrices, arrays::renderArrays::centerPosition, arrays::renderArrays::auxTest, arrays::renderArrays::auxIsoDensity, arrays::renderArrays::auxDistance, arrays::renderArrays::auxHashMap, arrays::renderArrays::auxCellSpan, arrays::renderArrays::auxCellInformation, arrays::renderArrays::auxCellSurface, arrays::structureArrays::classification, arrays::structureArrays::resortIndex, arrays::structureArrays::ZOrder_64, arrays::structureArrays::ZOrder_32, arrays::structureArrays::cellSpanSwap, arrays::structureArrays::cellSpan, arrays::structureArrays::compactCellSpanSwap, arrays::structureArrays::compactCellSpan, arrays::structureArrays::MLMResolution, arrays::structureArrays::cellparticleIndex, arrays::structureArrays::compactparticleIndex, arrays::structureArrays::particleparticleIndex, arrays::supportArrays::support, arrays::supportArrays::supportEstimate, arrays::supportArrays::neighborCount, arrays::supportArrays::supportMarker, arrays::supportArrays::supportMarkerCompacted, arrays::supportArrays::closestNeighbor, arrays::supportArrays::closestNeighbor_f, arrays::supportArrays::neighborOverhead, arrays::supportArrays::neighborOverheadCount> swapping_list;
...
auto iterateAllocationsList(C&& fn, Ts&&... args){
	...
	fn(arrays::adaptive::refinementRatio(), args...);
	fn(arrays::adaptive::splitIndicator(), args...);
	fn(arrays::adaptive::mergeIndicator(), args...);
	...
	fn(arrays::advectionArrays::vorticity(), args...);
	...
	fn(arrays::boundaryArrays::volumeBoundaryGVDBVolumes(), args...);
	fn(arrays::boundaryArrays::gvdbOffsets(), args...);
	fn(arrays::boundaryArrays::gvdbVoxelSizes(), args...);
	...
	fn(arrays::basicArrays::sdf_gridsize(), args...);
	fn(arrays::basicArrays::sdf_minpoint2(), args...);
	fn(arrays::basicArrays::sdf_minpoint1(), args...);
	fn(arrays::basicArrays::position(), args...);
	fn(arrays::basicArrays::acceleration(), args...);
	fn(arrays::basicArrays::acceleration_inter(), args...);
	fn(arrays::basicArrays::velocity(), args...);
	fn(arrays::basicArrays::rigidbody_sdf2(), args...);
	fn(arrays::basicArrays::particle_type(), args...);
	fn(arrays::basicArrays::tobeoptimized(), args...);
	fn(arrays::basicArrays::uid(), args...);
	...
	fn(arrays::basicArrays::optimization_lifetime(), args...);
	fn(arrays::basicArrays::optimization_lifetime_merge(), args...);
	fn(arrays::basicArrays::optimization_group(), args...);
	fn(arrays::basicArrays::pressure(), args...);
	fn(arrays::basicArrays::density(), args...);
	fn(arrays::basicArrays::old_density(), args...);
	fn(arrays::basicArrays::density_b(), args...);
	fn(arrays::basicArrays::density_f(), args...);
	...
	fn(arrays::structureArrays::refinementList(), args...);
	fn(arrays::structureArrays::neighborListLength(), args...);
	fn(arrays::structureArrays::refinementListLength(), args...);
	fn(arrays::renderArrays::auxLength(), args...);
	fn(arrays::renderArrays::anisotropicSupport(), args...);
...
auto iterateArraysList(C&& fn, Ts&&... args){
	...
	fn(arrays::basicArrays::acceleration_inter(), args...);
	fn(arrays::basicArrays::velocity(), args...);
	fn(arrays::basicArrays::rigidbody_sdf(), args...);
	fn(arrays::basicArrays::rigidbody_sdf2(), args...);
	fn(arrays::basicArrays::particle_type(), args...);
	fn(arrays::basicArrays::tobeoptimized(), args...);
	fn(arrays::basicArrays::uid(), args...);
	...
	fn(arrays::volumeInletArrays::outletGVDBVolumes(), args...);
	fn(arrays::volumeInletArrays::volumeOutletOffsets(), args...);
	fn(arrays::volumeInletArrays::volumeOutletVoxelSizes(), args...);
...
struct sortingArray{
	...
	std::pair<arrays::adaptive::mergeIndicator::type*, arrays::adaptive::mergeIndicator::type*> AdaptiveMergeIndicator;
	...
	std::pair<arrays::advectionArrays::vorticity::type*, arrays::advectionArrays::vorticity::type*> AdvectionArraysVorticity;
	...
	std::pair<arrays::basicArrays::acceleration_inter::type*, arrays::basicArrays::acceleration_inter::type*> BasicArraysAccelerationInter;
	std::pair<arrays::basicArrays::velocity::type*, arrays::basicArrays::velocity::type*> BasicArraysVelocity;
	std::pair<arrays::basicArrays::rigidbody_sdf2::type*, arrays::basicArrays::rigidbody_sdf2::type*> BasicArraysRigidbodySdf2;
	std::pair<arrays::basicArrays::particle_type::type*, arrays::basicArrays::particle_type::type*> BasicArraysParticleType;
	std::pair<arrays::basicArrays::tobeoptimized::type*, arrays::basicArrays::tobeoptimized::type*> BasicArraysTobeoptimized;
	std::pair<arrays::basicArrays::uid::type*, arrays::basicArrays::uid::type*> BasicArraysUid;
	...
	std::pair<arrays::basicArrays::optimization_lifetime::type*, arrays::basicArrays::optimization_lifetime::type*> BasicArraysOptimizationLifetime;
	std::pair<arrays::basicArrays::optimization_lifetime_merge::type*, arrays::basicArrays::optimization_lifetime_merge::type*> BasicArraysOptimizationLifetimeMerge;
	std::pair<arrays::basicArrays::optimization_group::type*, arrays::basicArrays::optimization_group::type*> BasicArraysOptimizationGroup;
	...
	std::pair<arrays::basicArrays::old_density::type*, arrays::basicArrays::old_density::type*> BasicArraysOldDensity;
	std::pair<arrays::basicArrays::density_b::type*, arrays::basicArrays::density_b::type*> BasicArraysDensityB;
	std::pair<arrays::basicArrays::density_f::type*, arrays::basicArrays::density_f::type*> BasicArraysDensityF;
	...
	std::pair<arrays::structureArrays::refinementListLength::type*, arrays::structureArrays::refinementListLength::type*> StructureArraysRefinementListLength;
	...
	hostInline void fillArray(){
		...
		AdaptiveMergeIndicator = std::make_pair( arrays::adaptive::mergeIndicator::ptr, arrays::adaptive::mergeIndicator::rear_ptr);
		...
		AdvectionArraysVorticity = std::make_pair( arrays::advectionArrays::vorticity::ptr, arrays::advectionArrays::vorticity::rear_ptr);
		...
		BasicArraysAccelerationInter = std::make_pair( arrays::basicArrays::acceleration_inter::ptr, arrays::basicArrays::acceleration_inter::rear_ptr);
		BasicArraysVelocity = std::make_pair( arrays::basicArrays::velocity::ptr, arrays::basicArrays::velocity::rear_ptr);
		BasicArraysRigidbodySdf2 = std::make_pair( arrays::basicArrays::rigidbody_sdf2::ptr, arrays::basicArrays::rigidbody_sdf2::rear_ptr);
		BasicArraysParticleType = std::make_pair( arrays::basicArrays::particle_type::ptr, arrays::basicArrays::particle_type::rear_ptr);
		BasicArraysTobeoptimized = std::make_pair( arrays::basicArrays::tobeoptimized::ptr, arrays::basicArrays::tobeoptimized::rear_ptr);
		BasicArraysUid = std::make_pair( arrays::basicArrays::uid::ptr, arrays::basicArrays::uid::rear_ptr);
		...
		BasicArraysOptimizationLifetime = std::make_pair( arrays::basicArrays::optimization_lifetime::ptr, arrays::basicArrays::optimization_lifetime::rear_ptr);
		BasicArraysOptimizationLifetimeMerge = std::make_pair( arrays::basicArrays::optimization_lifetime_merge::ptr, arrays::basicArrays::optimization_lifetime_merge::rear_ptr);
		BasicArraysOptimizationGroup = std::make_pair( arrays::basicArrays::optimization_group::ptr, arrays::basicArrays::optimization_group::rear_ptr);
		...
		BasicArraysOldDensity = std::make_pair( arrays::basicArrays::old_density::ptr, arrays::basicArrays::old_density::rear_ptr);
		BasicArraysDensityB = std::make_pair( arrays::basicArrays::density_b::ptr, arrays::basicArrays::density_b::rear_ptr);
		BasicArraysDensityF = std::make_pair( arrays::basicArrays::density_f::ptr, arrays::basicArrays::density_f::rear_ptr);
		...
		StructureArraysRefinementListLength = std::make_pair( arrays::structureArrays::refinementListLength::ptr, arrays::structureArrays::refinementListLength::rear_ptr);
	}
	...
	template<typename C> hostDeviceInline void callOnArray(C func){
		...
		func(AdaptiveMergeIndicator.first, AdaptiveMergeIndicator.second);
		...
		func(AdvectionArraysVorticity.first, AdvectionArraysVorticity.second);
		...
		func(BasicArraysAccelerationInter.first, BasicArraysAccelerationInter.second);
		func(BasicArraysVelocity.first, BasicArraysVelocity.second);
		func(BasicArraysRigidbodySdf2.first, BasicArraysRigidbodySdf2.second);
		func(BasicArraysParticleType.first, BasicArraysParticleType.second);
		func(BasicArraysTobeoptimized.first, BasicArraysTobeoptimized.second);
		func(BasicArraysUid.first, BasicArraysUid.second);
		...
		func(BasicArraysOptimizationLifetime.first, BasicArraysOptimizationLifetime.second);
		func(BasicArraysOptimizationLifetimeMerge.first, BasicArraysOptimizationLifetimeMerge.second);
		func(BasicArraysOptimizationGroup.first, BasicArraysOptimizationGroup.second);
		func(BasicArraysPressure.first, BasicArraysPressure.second);
		func(BasicArraysDensity.first, BasicArraysDensity.second);
		func(BasicArraysOldDensity.first, BasicArraysOldDensity.second);
		func(BasicArraysDensityB.first, BasicArraysDensityB.second);
		func(BasicArraysDensityF.first, BasicArraysDensityF.second);
		func(StructureArraysNeighborListLength.first, StructureArraysNeighborListLength.second);
		func(StructureArraysRefinementListLength.first, StructureArraysRefinementListLength.second);
	}
};
auto inline getArrayQualifiedName(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return arrays::adaptive::refinementRatio::qualifiedName;
		case array_enum::adaptive_splitIndicator: return arrays::adaptive::splitIndicator::qualifiedName;
		case array_enum::adaptive_mergeIndicator: return arrays::adaptive::mergeIndicator::qualifiedName;
		...
		case array_enum::advectionArrays_vorticity: return arrays::advectionArrays::vorticity::qualifiedName;
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return arrays::boundaryArrays::volumeBoundaryGVDBVolumes::qualifiedName;
		case array_enum::boundaryArrays_gvdbOffsets: return arrays::boundaryArrays::gvdbOffsets::qualifiedName;
		case array_enum::boundaryArrays_gvdbVoxelSizes: return arrays::boundaryArrays::gvdbVoxelSizes::qualifiedName;
		...
		case array_enum::basicArrays_sdf_gridsize: return arrays::basicArrays::sdf_gridsize::qualifiedName;
		case array_enum::basicArrays_sdf_minpoint2: return arrays::basicArrays::sdf_minpoint2::qualifiedName;
		case array_enum::basicArrays_sdf_minpoint1: return arrays::basicArrays::sdf_minpoint1::qualifiedName;
		...
		case array_enum::basicArrays_acceleration_inter: return arrays::basicArrays::acceleration_inter::qualifiedName;
		case array_enum::basicArrays_velocity: return arrays::basicArrays::velocity::qualifiedName;
		case array_enum::basicArrays_rigidbody_sdf: return arrays::basicArrays::rigidbody_sdf::qualifiedName;
		case array_enum::basicArrays_rigidbody_sdf2: return arrays::basicArrays::rigidbody_sdf2::qualifiedName;
		case array_enum::basicArrays_particle_type: return arrays::basicArrays::particle_type::qualifiedName;
		case array_enum::basicArrays_tobeoptimized: return arrays::basicArrays::tobeoptimized::qualifiedName;
		case array_enum::basicArrays_uid: return arrays::basicArrays::uid::qualifiedName;
		...
		case array_enum::basicArrays_optimization_lifetime: return arrays::basicArrays::optimization_lifetime::qualifiedName;
		case array_enum::basicArrays_optimization_lifetime_merge: return arrays::basicArrays::optimization_lifetime_merge::qualifiedName;
		case array_enum::basicArrays_optimization_group: return arrays::basicArrays::optimization_group::qualifiedName;
		...
		case array_enum::basicArrays_old_density: return arrays::basicArrays::old_density::qualifiedName;
		case array_enum::basicArrays_density_b: return arrays::basicArrays::density_b::qualifiedName;
		case array_enum::basicArrays_density_f: return arrays::basicArrays::density_f::qualifiedName;
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return arrays::volumeInletArrays::outletGVDBVolumes::qualifiedName;
		case array_enum::volumeInletArrays_volumeOutletOffsets: return arrays::volumeInletArrays::volumeOutletOffsets::qualifiedName;
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return arrays::volumeInletArrays::volumeOutletVoxelSizes::qualifiedName;
		...
		case array_enum::structureArrays_refinementList: return arrays::structureArrays::refinementList::qualifiedName;
		case array_enum::structureArrays_neighborListLength: return arrays::structureArrays::neighborListLength::qualifiedName;
		case array_enum::structureArrays_refinementListLength: return arrays::structureArrays::refinementListLength::qualifiedName;
		case array_enum::renderArrays_auxLength: return arrays::renderArrays::auxLength::qualifiedName;
		case array_enum::renderArrays_anisotropicSupport: return arrays::renderArrays::anisotropicSupport::qualifiedName;
...
auto inline getArrayVariableName(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return arrays::adaptive::refinementRatio::variableName;
		case array_enum::adaptive_splitIndicator: return arrays::adaptive::splitIndicator::variableName;
		case array_enum::adaptive_mergeIndicator: return arrays::adaptive::mergeIndicator::variableName;
		...
		case array_enum::advectionArrays_vorticity: return arrays::advectionArrays::vorticity::variableName;
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return arrays::boundaryArrays::volumeBoundaryGVDBVolumes::variableName;
		case array_enum::boundaryArrays_gvdbOffsets: return arrays::boundaryArrays::gvdbOffsets::variableName;
		case array_enum::boundaryArrays_gvdbVoxelSizes: return arrays::boundaryArrays::gvdbVoxelSizes::variableName;
		...
		case array_enum::basicArrays_sdf_gridsize: return arrays::basicArrays::sdf_gridsize::variableName;
		case array_enum::basicArrays_sdf_minpoint2: return arrays::basicArrays::sdf_minpoint2::variableName;
		case array_enum::basicArrays_sdf_minpoint1: return arrays::basicArrays::sdf_minpoint1::variableName;
		...
		case array_enum::basicArrays_acceleration_inter: return arrays::basicArrays::acceleration_inter::variableName;
		case array_enum::basicArrays_velocity: return arrays::basicArrays::velocity::variableName;
		case array_enum::basicArrays_rigidbody_sdf: return arrays::basicArrays::rigidbody_sdf::variableName;
		case array_enum::basicArrays_rigidbody_sdf2: return arrays::basicArrays::rigidbody_sdf2::variableName;
		case array_enum::basicArrays_particle_type: return arrays::basicArrays::particle_type::variableName;
		case array_enum::basicArrays_tobeoptimized: return arrays::basicArrays::tobeoptimized::variableName;
		case array_enum::basicArrays_uid: return arrays::basicArrays::uid::variableName;
		...
		case array_enum::basicArrays_optimization_lifetime: return arrays::basicArrays::optimization_lifetime::variableName;
		case array_enum::basicArrays_optimization_lifetime_merge: return arrays::basicArrays::optimization_lifetime_merge::variableName;
		case array_enum::basicArrays_optimization_group: return arrays::basicArrays::optimization_group::variableName;
		...
		case array_enum::basicArrays_old_density: return arrays::basicArrays::old_density::variableName;
		case array_enum::basicArrays_density_b: return arrays::basicArrays::density_b::variableName;
		case array_enum::basicArrays_density_f: return arrays::basicArrays::density_f::variableName;
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return arrays::volumeInletArrays::outletGVDBVolumes::variableName;
		case array_enum::volumeInletArrays_volumeOutletOffsets: return arrays::volumeInletArrays::volumeOutletOffsets::variableName;
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return arrays::volumeInletArrays::volumeOutletVoxelSizes::variableName;
		...
		case array_enum::structureArrays_refinementList: return arrays::structureArrays::refinementList::variableName;
		case array_enum::structureArrays_neighborListLength: return arrays::structureArrays::neighborListLength::variableName;
		case array_enum::structureArrays_refinementListLength: return arrays::structureArrays::refinementListLength::variableName;
		case array_enum::renderArrays_auxLength: return arrays::renderArrays::auxLength::variableName;
		case array_enum::renderArrays_anisotropicSupport: return arrays::renderArrays::anisotropicSupport::variableName;
...
auto inline getArrayPtr(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return (void*) arrays::adaptive::refinementRatio::ptr;
		case array_enum::adaptive_splitIndicator: return (void*) arrays::adaptive::splitIndicator::ptr;
		case array_enum::adaptive_mergeIndicator: return (void*) arrays::adaptive::mergeIndicator::ptr;
		...
		case array_enum::advectionArrays_vorticity: return (void*) arrays::advectionArrays::vorticity::ptr;
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return (void*) arrays::boundaryArrays::volumeBoundaryGVDBVolumes::ptr;
		case array_enum::boundaryArrays_gvdbOffsets: return (void*) arrays::boundaryArrays::gvdbOffsets::ptr;
		case array_enum::boundaryArrays_gvdbVoxelSizes: return (void*) arrays::boundaryArrays::gvdbVoxelSizes::ptr;
		...
		case array_enum::basicArrays_sdf_gridsize: return (void*) arrays::basicArrays::sdf_gridsize::ptr;
		case array_enum::basicArrays_sdf_minpoint2: return (void*) arrays::basicArrays::sdf_minpoint2::ptr;
		case array_enum::basicArrays_sdf_minpoint1: return (void*) arrays::basicArrays::sdf_minpoint1::ptr;
		...
		case array_enum::basicArrays_acceleration_inter: return (void*) arrays::basicArrays::acceleration_inter::ptr;
		case array_enum::basicArrays_velocity: return (void*) arrays::basicArrays::velocity::ptr;
		case array_enum::basicArrays_rigidbody_sdf: return (void*) arrays::basicArrays::rigidbody_sdf::ptr;
		case array_enum::basicArrays_rigidbody_sdf2: return (void*) arrays::basicArrays::rigidbody_sdf2::ptr;
		case array_enum::basicArrays_particle_type: return (void*) arrays::basicArrays::particle_type::ptr;
		case array_enum::basicArrays_tobeoptimized: return (void*) arrays::basicArrays::tobeoptimized::ptr;
		case array_enum::basicArrays_uid: return (void*) arrays::basicArrays::uid::ptr;
		...
		case array_enum::basicArrays_optimization_lifetime: return (void*) arrays::basicArrays::optimization_lifetime::ptr;
		case array_enum::basicArrays_optimization_lifetime_merge: return (void*) arrays::basicArrays::optimization_lifetime_merge::ptr;
		case array_enum::basicArrays_optimization_group: return (void*) arrays::basicArrays::optimization_group::ptr;
		...
		case array_enum::basicArrays_old_density: return (void*) arrays::basicArrays::old_density::ptr;
		case array_enum::basicArrays_density_b: return (void*) arrays::basicArrays::density_b::ptr;
		case array_enum::basicArrays_density_f: return (void*) arrays::basicArrays::density_f::ptr;
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return (void*) arrays::volumeInletArrays::outletGVDBVolumes::ptr;
		case array_enum::volumeInletArrays_volumeOutletOffsets: return (void*) arrays::volumeInletArrays::volumeOutletOffsets::ptr;
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return (void*) arrays::volumeInletArrays::volumeOutletVoxelSizes::ptr;
		...
		case array_enum::structureArrays_refinementList: return (void*) arrays::structureArrays::refinementList::ptr;
		case array_enum::structureArrays_neighborListLength: return (void*) arrays::structureArrays::neighborListLength::ptr;
		case array_enum::structureArrays_refinementListLength: return (void*) arrays::structureArrays::refinementListLength::ptr;
		case array_enum::renderArrays_auxLength: return (void*) arrays::renderArrays::auxLength::ptr;
		case array_enum::renderArrays_anisotropicSupport: return (void*) arrays::renderArrays::anisotropicSupport::ptr;
...
auto inline getArrayAllocationSize(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return arrays::adaptive::refinementRatio::alloc_size;
		case array_enum::adaptive_splitIndicator: return arrays::adaptive::splitIndicator::alloc_size;
		case array_enum::adaptive_mergeIndicator: return arrays::adaptive::mergeIndicator::alloc_size;
		...
		case array_enum::advectionArrays_vorticity: return arrays::advectionArrays::vorticity::alloc_size;
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return arrays::boundaryArrays::volumeBoundaryGVDBVolumes::alloc_size;
		case array_enum::boundaryArrays_gvdbOffsets: return arrays::boundaryArrays::gvdbOffsets::alloc_size;
		case array_enum::boundaryArrays_gvdbVoxelSizes: return arrays::boundaryArrays::gvdbVoxelSizes::alloc_size;
		...
		case array_enum::basicArrays_sdf_gridsize: return arrays::basicArrays::sdf_gridsize::alloc_size;
		case array_enum::basicArrays_sdf_minpoint2: return arrays::basicArrays::sdf_minpoint2::alloc_size;
		case array_enum::basicArrays_sdf_minpoint1: return arrays::basicArrays::sdf_minpoint1::alloc_size;
		...
		case array_enum::basicArrays_acceleration_inter: return arrays::basicArrays::acceleration_inter::alloc_size;
		case array_enum::basicArrays_velocity: return arrays::basicArrays::velocity::alloc_size;
		case array_enum::basicArrays_rigidbody_sdf: return arrays::basicArrays::rigidbody_sdf::alloc_size;
		case array_enum::basicArrays_rigidbody_sdf2: return arrays::basicArrays::rigidbody_sdf2::alloc_size;
		case array_enum::basicArrays_particle_type: return arrays::basicArrays::particle_type::alloc_size;
		case array_enum::basicArrays_tobeoptimized: return arrays::basicArrays::tobeoptimized::alloc_size;
		case array_enum::basicArrays_uid: return arrays::basicArrays::uid::alloc_size;
		...
		case array_enum::basicArrays_optimization_lifetime: return arrays::basicArrays::optimization_lifetime::alloc_size;
		case array_enum::basicArrays_optimization_lifetime_merge: return arrays::basicArrays::optimization_lifetime_merge::alloc_size;
		case array_enum::basicArrays_optimization_group: return arrays::basicArrays::optimization_group::alloc_size;
		...
		case array_enum::basicArrays_old_density: return arrays::basicArrays::old_density::alloc_size;
		case array_enum::basicArrays_density_b: return arrays::basicArrays::density_b::alloc_size;
		case array_enum::basicArrays_density_f: return arrays::basicArrays::density_f::alloc_size;
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return arrays::volumeInletArrays::outletGVDBVolumes::alloc_size;
		case array_enum::volumeInletArrays_volumeOutletOffsets: return arrays::volumeInletArrays::volumeOutletOffsets::alloc_size;
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return arrays::volumeInletArrays::volumeOutletVoxelSizes::alloc_size;
		...
		case array_enum::structureArrays_refinementList: return arrays::structureArrays::refinementList::alloc_size;
		case array_enum::structureArrays_neighborListLength: return arrays::structureArrays::neighborListLength::alloc_size;
		case array_enum::structureArrays_refinementListLength: return arrays::structureArrays::refinementListLength::alloc_size;
		case array_enum::renderArrays_auxLength: return arrays::renderArrays::auxLength::alloc_size;
		case array_enum::renderArrays_anisotropicSupport: return arrays::renderArrays::anisotropicSupport::alloc_size;
...
auto inline getArrayKind(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return arrays::adaptive::refinementRatio::kind;
		case array_enum::adaptive_splitIndicator: return arrays::adaptive::splitIndicator::kind;
		case array_enum::adaptive_mergeIndicator: return arrays::adaptive::mergeIndicator::kind;
		...
		case array_enum::advectionArrays_vorticity: return arrays::advectionArrays::vorticity::kind;
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return arrays::boundaryArrays::volumeBoundaryGVDBVolumes::kind;
		case array_enum::boundaryArrays_gvdbOffsets: return arrays::boundaryArrays::gvdbOffsets::kind;
		case array_enum::boundaryArrays_gvdbVoxelSizes: return arrays::boundaryArrays::gvdbVoxelSizes::kind;
		...
		case array_enum::basicArrays_sdf_gridsize: return arrays::basicArrays::sdf_gridsize::kind;
		case array_enum::basicArrays_sdf_minpoint2: return arrays::basicArrays::sdf_minpoint2::kind;
		case array_enum::basicArrays_sdf_minpoint1: return arrays::basicArrays::sdf_minpoint1::kind;
		...
		case array_enum::basicArrays_acceleration_inter: return arrays::basicArrays::acceleration_inter::kind;
		case array_enum::basicArrays_velocity: return arrays::basicArrays::velocity::kind;
		case array_enum::basicArrays_rigidbody_sdf: return arrays::basicArrays::rigidbody_sdf::kind;
		case array_enum::basicArrays_rigidbody_sdf2: return arrays::basicArrays::rigidbody_sdf2::kind;
		case array_enum::basicArrays_particle_type: return arrays::basicArrays::particle_type::kind;
		case array_enum::basicArrays_tobeoptimized: return arrays::basicArrays::tobeoptimized::kind;
		case array_enum::basicArrays_uid: return arrays::basicArrays::uid::kind;
		...
		case array_enum::basicArrays_optimization_lifetime: return arrays::basicArrays::optimization_lifetime::kind;
		case array_enum::basicArrays_optimization_lifetime_merge: return arrays::basicArrays::optimization_lifetime_merge::kind;
		case array_enum::basicArrays_optimization_group: return arrays::basicArrays::optimization_group::kind;
		...
		case array_enum::basicArrays_old_density: return arrays::basicArrays::old_density::kind;
		case array_enum::basicArrays_density_b: return arrays::basicArrays::density_b::kind;
		case array_enum::basicArrays_density_f: return arrays::basicArrays::density_f::kind;
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return arrays::volumeInletArrays::outletGVDBVolumes::kind;
		case array_enum::volumeInletArrays_volumeOutletOffsets: return arrays::volumeInletArrays::volumeOutletOffsets::kind;
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return arrays::volumeInletArrays::volumeOutletVoxelSizes::kind;
		...
		case array_enum::structureArrays_refinementList: return arrays::structureArrays::refinementList::kind;
		case array_enum::structureArrays_neighborListLength: return arrays::structureArrays::neighborListLength::kind;
		case array_enum::structureArrays_refinementListLength: return arrays::structureArrays::refinementListLength::kind;
		case array_enum::renderArrays_auxLength: return arrays::renderArrays::auxLength::kind;
		case array_enum::renderArrays_anisotropicSupport: return arrays::renderArrays::anisotropicSupport::kind;
...
auto inline getArrayDescription(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return arrays::adaptive::refinementRatio::description;
		case array_enum::adaptive_splitIndicator: return arrays::adaptive::splitIndicator::description;
		case array_enum::adaptive_mergeIndicator: return arrays::adaptive::mergeIndicator::description;
		...
		case array_enum::advectionArrays_vorticity: return arrays::advectionArrays::vorticity::description;
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return arrays::boundaryArrays::volumeBoundaryGVDBVolumes::description;
		case array_enum::boundaryArrays_gvdbOffsets: return arrays::boundaryArrays::gvdbOffsets::description;
		case array_enum::boundaryArrays_gvdbVoxelSizes: return arrays::boundaryArrays::gvdbVoxelSizes::description;
		...
		case array_enum::basicArrays_sdf_gridsize: return arrays::basicArrays::sdf_gridsize::description;
		case array_enum::basicArrays_sdf_minpoint2: return arrays::basicArrays::sdf_minpoint2::description;
		case array_enum::basicArrays_sdf_minpoint1: return arrays::basicArrays::sdf_minpoint1::description;
		...
		case array_enum::basicArrays_acceleration_inter: return arrays::basicArrays::acceleration_inter::description;
		case array_enum::basicArrays_velocity: return arrays::basicArrays::velocity::description;
		case array_enum::basicArrays_rigidbody_sdf: return arrays::basicArrays::rigidbody_sdf::description;
		case array_enum::basicArrays_rigidbody_sdf2: return arrays::basicArrays::rigidbody_sdf2::description;
		case array_enum::basicArrays_particle_type: return arrays::basicArrays::particle_type::description;
		case array_enum::basicArrays_tobeoptimized: return arrays::basicArrays::tobeoptimized::description;
		case array_enum::basicArrays_uid: return arrays::basicArrays::uid::description;
		...
		case array_enum::basicArrays_optimization_lifetime: return arrays::basicArrays::optimization_lifetime::description;
		case array_enum::basicArrays_optimization_lifetime_merge: return arrays::basicArrays::optimization_lifetime_merge::description;
		case array_enum::basicArrays_optimization_group: return arrays::basicArrays::optimization_group::description;
		...
		case array_enum::basicArrays_old_density: return arrays::basicArrays::old_density::description;
		case array_enum::basicArrays_density_b: return arrays::basicArrays::density_b::description;
		case array_enum::basicArrays_density_f: return arrays::basicArrays::density_f::description;
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return arrays::volumeInletArrays::outletGVDBVolumes::description;
		case array_enum::volumeInletArrays_volumeOutletOffsets: return arrays::volumeInletArrays::volumeOutletOffsets::description;
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return arrays::volumeInletArrays::volumeOutletVoxelSizes::description;
		...
		case array_enum::structureArrays_refinementList: return arrays::structureArrays::refinementList::description;
		case array_enum::structureArrays_neighborListLength: return arrays::structureArrays::neighborListLength::description;
		case array_enum::structureArrays_refinementListLength: return arrays::structureArrays::refinementListLength::description;
		case array_enum::renderArrays_auxLength: return arrays::renderArrays::auxLength::description;
		case array_enum::renderArrays_anisotropicSupport: return arrays::renderArrays::anisotropicSupport::description;
...
auto inline getArrayType(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return type_name<arrays::adaptive::refinementRatio::type>();
		case array_enum::adaptive_splitIndicator: return type_name<arrays::adaptive::splitIndicator::type>();
		case array_enum::adaptive_mergeIndicator: return type_name<arrays::adaptive::mergeIndicator::type>();
		...
		case array_enum::advectionArrays_vorticity: return type_name<arrays::advectionArrays::vorticity::type>();
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return type_name<arrays::boundaryArrays::volumeBoundaryGVDBVolumes::type>();
		case array_enum::boundaryArrays_gvdbOffsets: return type_name<arrays::boundaryArrays::gvdbOffsets::type>();
		case array_enum::boundaryArrays_gvdbVoxelSizes: return type_name<arrays::boundaryArrays::gvdbVoxelSizes::type>();
		...
		case array_enum::basicArrays_sdf_gridsize: return type_name<arrays::basicArrays::sdf_gridsize::type>();
		case array_enum::basicArrays_sdf_minpoint2: return type_name<arrays::basicArrays::sdf_minpoint2::type>();
		case array_enum::basicArrays_sdf_minpoint1: return type_name<arrays::basicArrays::sdf_minpoint1::type>();
		...
		case array_enum::basicArrays_acceleration_inter: return type_name<arrays::basicArrays::acceleration_inter::type>();
		case array_enum::basicArrays_velocity: return type_name<arrays::basicArrays::velocity::type>();
		case array_enum::basicArrays_rigidbody_sdf: return type_name<arrays::basicArrays::rigidbody_sdf::type>();
		case array_enum::basicArrays_rigidbody_sdf2: return type_name<arrays::basicArrays::rigidbody_sdf2::type>();
		case array_enum::basicArrays_particle_type: return type_name<arrays::basicArrays::particle_type::type>();
		case array_enum::basicArrays_tobeoptimized: return type_name<arrays::basicArrays::tobeoptimized::type>();
		case array_enum::basicArrays_uid: return type_name<arrays::basicArrays::uid::type>();
		...
		case array_enum::basicArrays_optimization_lifetime: return type_name<arrays::basicArrays::optimization_lifetime::type>();
		case array_enum::basicArrays_optimization_lifetime_merge: return type_name<arrays::basicArrays::optimization_lifetime_merge::type>();
		case array_enum::basicArrays_optimization_group: return type_name<arrays::basicArrays::optimization_group::type>();
		...
		case array_enum::basicArrays_old_density: return type_name<arrays::basicArrays::old_density::type>();
		case array_enum::basicArrays_density_b: return type_name<arrays::basicArrays::density_b::type>();
		case array_enum::basicArrays_density_f: return type_name<arrays::basicArrays::density_f::type>();
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return type_name<arrays::volumeInletArrays::outletGVDBVolumes::type>();
		case array_enum::volumeInletArrays_volumeOutletOffsets: return type_name<arrays::volumeInletArrays::volumeOutletOffsets::type>();
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return type_name<arrays::volumeInletArrays::volumeOutletVoxelSizes::type>();
		...
		case array_enum::structureArrays_refinementList: return type_name<arrays::structureArrays::refinementList::type>();
		case array_enum::structureArrays_neighborListLength: return type_name<arrays::structureArrays::neighborListLength::type>();
		case array_enum::structureArrays_refinementListLength: return type_name<arrays::structureArrays::refinementListLength::type>();
		case array_enum::renderArrays_auxLength: return type_name<arrays::renderArrays::auxLength::type>();
		case array_enum::renderArrays_anisotropicSupport: return type_name<arrays::renderArrays::anisotropicSupport::type>();
...
auto inline getArraySwappable(array_enum e){
	switch(e){
		...
		case array_enum::adaptive_refinementRatio: return has_rear_ptr<arrays::adaptive::refinementRatio> ;
		case array_enum::adaptive_splitIndicator: return has_rear_ptr<arrays::adaptive::splitIndicator> ;
		case array_enum::adaptive_mergeIndicator: return has_rear_ptr<arrays::adaptive::mergeIndicator> ;
		...
		case array_enum::advectionArrays_vorticity: return has_rear_ptr<arrays::advectionArrays::vorticity> ;
		...
		case array_enum::boundaryArrays_volumeBoundaryGVDBVolumes: return has_rear_ptr<arrays::boundaryArrays::volumeBoundaryGVDBVolumes> ;
		case array_enum::boundaryArrays_gvdbOffsets: return has_rear_ptr<arrays::boundaryArrays::gvdbOffsets> ;
		case array_enum::boundaryArrays_gvdbVoxelSizes: return has_rear_ptr<arrays::boundaryArrays::gvdbVoxelSizes> ;
		...
		case array_enum::basicArrays_sdf_gridsize: return has_rear_ptr<arrays::basicArrays::sdf_gridsize> ;
		case array_enum::basicArrays_sdf_minpoint2: return has_rear_ptr<arrays::basicArrays::sdf_minpoint2> ;
		case array_enum::basicArrays_sdf_minpoint1: return has_rear_ptr<arrays::basicArrays::sdf_minpoint1> ;
		...
		case array_enum::basicArrays_acceleration_inter: return has_rear_ptr<arrays::basicArrays::acceleration_inter> ;
		case array_enum::basicArrays_velocity: return has_rear_ptr<arrays::basicArrays::velocity> ;
		case array_enum::basicArrays_rigidbody_sdf: return has_rear_ptr<arrays::basicArrays::rigidbody_sdf> ;
		case array_enum::basicArrays_rigidbody_sdf2: return has_rear_ptr<arrays::basicArrays::rigidbody_sdf2> ;
		case array_enum::basicArrays_particle_type: return has_rear_ptr<arrays::basicArrays::particle_type> ;
		case array_enum::basicArrays_tobeoptimized: return has_rear_ptr<arrays::basicArrays::tobeoptimized> ;
		case array_enum::basicArrays_uid: return has_rear_ptr<arrays::basicArrays::uid> ;
		...
		case array_enum::basicArrays_optimization_lifetime: return has_rear_ptr<arrays::basicArrays::optimization_lifetime> ;
		case array_enum::basicArrays_optimization_lifetime_merge: return has_rear_ptr<arrays::basicArrays::optimization_lifetime_merge> ;
		case array_enum::basicArrays_optimization_group: return has_rear_ptr<arrays::basicArrays::optimization_group> ;
		...
		case array_enum::basicArrays_old_density: return has_rear_ptr<arrays::basicArrays::old_density> ;
		case array_enum::basicArrays_density_b: return has_rear_ptr<arrays::basicArrays::density_b> ;
		case array_enum::basicArrays_density_f: return has_rear_ptr<arrays::basicArrays::density_f> ;
		...
		case array_enum::volumeInletArrays_outletGVDBVolumes: return has_rear_ptr<arrays::volumeInletArrays::outletGVDBVolumes> ;
		case array_enum::volumeInletArrays_volumeOutletOffsets: return has_rear_ptr<arrays::volumeInletArrays::volumeOutletOffsets> ;
		case array_enum::volumeInletArrays_volumeOutletVoxelSizes: return has_rear_ptr<arrays::volumeInletArrays::volumeOutletVoxelSizes> ;
		...
		case array_enum::structureArrays_refinementList: return has_rear_ptr<arrays::structureArrays::refinementList> ;
		case array_enum::structureArrays_neighborListLength: return has_rear_ptr<arrays::structureArrays::neighborListLength> ;
		case array_enum::structureArrays_refinementListLength: return has_rear_ptr<arrays::structureArrays::refinementListLength> ;
		case array_enum::renderArrays_auxLength: return has_rear_ptr<arrays::renderArrays::auxLength> ;
		case array_enum::renderArrays_anisotropicSupport: return has_rear_ptr<arrays::renderArrays::anisotropicSupport> ;
