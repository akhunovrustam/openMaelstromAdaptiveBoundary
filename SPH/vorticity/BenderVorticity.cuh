...
namespace SPH{
	namespace BenderVorticity{
		struct Memory{
			...
			// parameters
			float intertiaInverse;
			float viscosityOmega;
...
constexpr static const bool inlet = false;
		...
		inline void setupParameters(Memory& arrays){
			...
			arrays.intertiaInverse = uGet<parameters::vorticitySettings::intertiaInverse>();
			arrays.viscosityOmega = uGet<parameters::vorticitySettings::viscosityOmega>();
			arrays.vorticityCoeff = uGet<parameters::vorticitySettings::vorticityCoeff>();
