...
namespace SPH{
	namespace Density{
		struct Memory{
			...
			write_array_u<arrays::density_f> density_f;
			write_array_u<arrays::density_b> density_b;
			...
			using input_arrays = std::tuple<arrays::position, arrays::particle_type, arrays::volume, arrays::boundaryPlanes, arrays::rigidDensities, arrays::uid>;
			using output_arrays = std::tuple<arrays::density, arrays::density_f, arrays::density_b, arrays::matrixTest, arrays::lifetime>;
