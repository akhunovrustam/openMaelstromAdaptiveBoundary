...
*/
namespace SPH{
	namespace IISPH17_PRESSURE_BOUNDARIES_D{
		struct Memory{
			// basic information
			int32_t num_ptcls;
			...
			using input_arrays = std::tuple<arrays::position, arrays::density, arrays::density_f, arrays::density_b, arrays::volume, arrays::particle_type, arrays::rigidDensities, arrays::uid>;
			using output_arrays = std::tuple<arrays::acceleration, arrays::velocity, arrays::_sourceTerm>;
...
constexpr static const bool inlet = false;
	...
	} // namspace IISPH17_PRESSURE_BOUNDARIES_D
}// namespace SPH
