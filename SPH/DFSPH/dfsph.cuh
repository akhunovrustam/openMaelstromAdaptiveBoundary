...
namespace SPH{
	namespace DFSPH{
		struct Memory{
			...
			// parameters
			float blendSteps;
			uFloat<SI::velocity> boundaryViscosity;
			...
			using input_arrays = std::tuple<arrays::position, arrays::density, arrays::particle_type>;
			using output_arrays = std::tuple<arrays::acceleration, arrays::volume, arrays::volumeBoundaryAcceleration, arrays::volumeBoundaryAngularAcceleration, arrays::lifetime>;
			using temporary_arrays = std::tuple<arrays::boundaryPressure, arrays::dfsphSource, arrays::dfsphAlpha, arrays::apparentVolume, arrays::predictedAcceleration, arrays::dfsphDpDt, arrays::dfsphRhoStar>;
...
constexpr static const bool inlet = false;
		...
		inline void setupParameters(Memory& arrays){
			...
			arrays.boundaryViscosity = uGet<parameters::particle_settings::boundaryViscosity>();
