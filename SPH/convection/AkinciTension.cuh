...
namespace SPH{
	namespace AkinciTension{
		struct Memory{
			...
			uFloat<SI::acceleration> rigidAdhesion_akinci;
			uFloat<SI::acceleration> boundaryAdhesion_akinci;
			...
			using input_arrays = std::tuple<arrays::velocity, arrays::position, arrays::density, arrays::density_f, arrays::volume>;
...
constexpr static const bool inlet = false;
		...
		inline void setupParameters(Memory& arrays){
			...
			arrays.rigidAdhesion_akinci = uGet<parameters::particle_settings::rigidAdhesion_akinci>();
			arrays.boundaryAdhesion_akinci = uGet<parameters::particle_settings::boundaryAdhesion_akinci>();
